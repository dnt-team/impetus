...
// Local
use impetus_runtime::{opaque::Block, AccountId, Balance, Index};
...
pub type Client = FullClient<impetus_runtime::RuntimeApi, TemplateRuntimeExecutor>;
...
impl NativeExecutionDispatch for TemplateRuntimeExecutor {
	...
	fn dispatch(method: &str, data: &[u8]) -> Option<Vec<u8>> {
		impetus_runtime::api::dispatch(method, data)
	}

	fn native_version() -> NativeVersion {
		impetus_runtime::native_version()
	}
}
